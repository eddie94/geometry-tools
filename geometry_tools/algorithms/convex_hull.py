from geometry_tools.lib.point import (Point2D, PointList, cross_product,
...
def convex_hull(points: list[Point2D] | Polygon) -> Polygon:
    if isinstance(points, Polygon):
        ...
        raise ValueError("Input must be a list of Point2D or a Polygon.")
